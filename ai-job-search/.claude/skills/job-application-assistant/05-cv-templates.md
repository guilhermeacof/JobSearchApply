...
<!-- Populado pelo /setup em 2026-07-11 a partir do CV -->
**For Analista de QA Sênior / Analista de Testes Sênior roles:**
> Analista de Qualidade Sênior com 13 anos em tecnologia e trajetória completa em testes — do manual à arquitetura de automação. Experiência consolidada em clientes de grande porte (Polícia Federal, TSE, DATASUS, CAIXA, SICOOB) implantando processos de qualidade e automatizando testes Web, API e mobile com Playwright, Cypress, Selenium e Robot Framework. Certificado CTFL, CSM e CPRE-FL, com forte atuação em times ágeis e formação de novos QAs.

**For Arquiteto de Testes / QA Lead roles:**
> Arquiteto de Testes Sênior com 13 anos de experiência estruturando qualidade de software em organizações de grande porte. Define estratégias de teste ponta a ponta, implanta pipelines de automação em CI/CD e lidera/capacita equipes de QA — combinando profundidade técnica em múltiplas stacks (JavaScript, C#, Java, Python) com visão de processo (CTFL, CPRE-FL, Prince2, Management 3.0). Histórico de implantação de processos de qualidade na Polícia Federal, SERPRO e Ministério da Saúde.

**For Analista de Automação de Testes / SDET roles:**
> Especialista em automação de testes com domínio das principais stacks do mercado: Playwright e Cypress (JavaScript), Selenium (C# e Java), Robot Framework + Appium (Python, mobile) e JMeter (performance). Integra automação a pipelines de CI/CD (GitHub/GitLab) e aplica BDD do desenho do cenário à evidência. 13 anos de bagagem em tecnologia garantem leitura rápida de sistemas complexos e legados.
